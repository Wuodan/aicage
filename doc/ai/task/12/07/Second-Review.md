...
I am picky on this, the trask instruction documents reference `doc/python-test-structure-guidelines.md` and in this
session I already had to remind you about guidelines in `doc/python-test-structure-guidelines.md`.
...
This is totally non-acceptable. If you further continue this pattern I will have you cough up a test just to validate
test-structure.
...
The above modules are still public. Looking where they are used outside their package shows places where user is prompted outside the 
`prompts` package.
...
The other thing which is even harder for me to detect during reviews is where methods or modules are public without 
need.
