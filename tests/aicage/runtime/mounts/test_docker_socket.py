...
class DockerSocketMountTests(TestCase):
    def test_resolve_docker_socket_mount_persists_socket(self) -> None:
        ...
        with mock.patch("aicage.runtime.mounts._docker_socket.prompt_persist_docker_socket", return_value=True):
            mounts = resolve_docker_socket_mount(agent_cfg, True)
    ...
    def test_resolve_docker_socket_mount_uses_persisted_socket(self) -> None:
        ...
        with mock.patch("aicage.runtime.mounts._docker_socket.prompt_persist_docker_socket") as prompt_mock:
