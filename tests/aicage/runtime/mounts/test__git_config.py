...
from aicage.runtime.mounts import _git_config
...
class GitConfigTests(TestCase):
    ...
    def test_resolve_git_config_mount_prompts_when_unset(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with (
                mock.patch(
                    "aicage.runtime.mounts._git_config._resolve_git_config_path",
                    return_value=git_config,
                ),
                mock.patch(
                    "aicage.runtime.mounts._git_config.prompt_mount_git_config",
                    return_value=True,
                ) as prompt_mock,
            ):
